...
export default function TableWithChairs({
  ...
  return (
    <div className="relative w-18 h-18 cursor-pointer">
      ...
      {/* Mesa */}
      <div onClick={() => onClick && onClick(id)} className={`z-10 hover:scale-[1.03] transition-transform w-18 h-18 ${hasOrder ? "bg-green-400" : "bg-gray-400"} flex items-center justify-center mx-auto my-auto border-gray-600 text-xs font-bold text-black`} >
        {label}
      </div>
